...
import { Button, StyleSheet, Text, View, TextInput, Keyboard, ImageBackground, Pressable, Touchable } from 'react-native';
...
export default function Book1() {
    ...
    const calculateValuesTotal = (listening, reading, composition) => {
      return (8 - ((listening*0.1) + (reading*0.15))) + composition;
    }

    /*Calcula o Valor da Prova somente */
    const calculateValues = (listening, reading) => {
      return (8 - ((listening*0.1) + (reading*0.15)));
    }
    ...
    return (
      <View style={[styles.tela]}>
        ...
        <TextInput style={[styles.textoInput, {marginBottom: 50}]}
          ...
          keyboardType="numeric"
          onSubmitEditing={()=> {
          setProva(calculateValues(listening,reading));
